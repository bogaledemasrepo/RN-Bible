...
export const books = [
  ...
  {
    book_id: 11,
    name_am: 'መጽሐፈ ነገሥት ቀዳማዊ',
    name_en: '1 Kings',
    short_name_am: '1 ነገ',
    short_name_en: '1 Kings',
    testament: 'old',
    total_chapters: 44,
  },
  {
    book_id: 12,
    name_am: 'መጽሐፈ ነገሥት ካልዕ',
    name_en: '2 Kings',
    short_name_am: '2 ነገ',
    short_name_en: '2 Kings',
    testament: 'old',
    total_chapters: 52,
  },
  {
    book_id: 13,
    name_am: 'መጽሐፈ ዜና መዋዕል ቀዳማዊ',
    name_en: '1 Chronicles',
    short_name_am: '1 ዜመ',
    short_name_en: '1 Chron',
    testament: 'old',
    total_chapters: 45,
  },
  {
    book_id: 14,
    name_am: 'መጽሐፈ ዜና መዋዕል ካልዕ',
    name_en: '2 Chronicles',
    short_name_am: '2 መዜ',
    short_name_en: '2 Chron',
    testament: 'old',
    total_chapters: 46,
  },
  {
  ...
  {
    book_id: 19,
    name_am: 'መጽሐፈ ዕዝራ ሱቱኤል',
    name_en: '3 Book of Ezra',
    short_name_am: 'ዕዝ ሱቱ',
    short_name_en: '3 Ezr',
    testament: 'old',
    total_chapters: 32,
  ...
  {
    book_id: 20,
    name_am: 'መጽሐፈ ዕዝራ ካልእ',
    name_en: '4 Book of Ezra',
    short_name_am: 'ዕዝ ካል',
    short_name_en: '4 Ezr',
    testament: 'old',
    total_chapters: 31,
  ...
  },
  {
    book_id: 22,
    name_am: 'መጽሐፈ ዮዲት',
    name_en: 'Book of Judith',
    short_name_am: 'ዮዲ',
    short_name_en: 'Judith',
    testament: 'old',
    total_chapters: 25,
  },
  {
  ...
  {
    book_id: 24,
    name_am: 'መጽሐፈ መቃብያን ቀዳማዊ',
    name_en: '1 Meqabyan',
    short_name_am: '1 መቃ',
    short_name_en: '1 Meqa',
    testament: 'old',
    total_chapters: 36,
  },
  {
    book_id: 25,
    name_am: 'መጽሐፈ መቃብያን ካልእ',
    name_en: '2 Meqabyan',
    short_name_am: '2 መቃ',
    short_name_en: '2 Meqa',
    testament: 'old',
    total_chapters: 21,
  },
  {
    book_id: 26,
    name_am: 'መጽሐፈ መቃብያን ሳልስ',
    name_en: '3 Meqabyan',
    short_name_am: '3 መቃ',
    short_name_en: '3 Meqa',
    testament: 'old',
    total_chapters: 10,
  },
  {
  ...
  {
    book_id: 67,
    name_am: '1ኛ ወደ ተሰሎንቄ ሰዎች',
    name_en: '1 Thessalonians',
    short_name_am: '1 ተሰ',
    short_name_en: '1 Thess',
    testament: 'new',
    total_chapters: 9,
  },
  {
    book_id: 68,
    name_am: '2ኛ ወደ ተሰሎንቄ ሰዎች',
    name_en: '2 Thessalonians',
    short_name_am: '2 ተሰ',
    short_name_en: '2 Thess',
    testament: 'new',
    total_chapters: 7,
  },
  {
  ...
  {
    book_id: 77,
    name_am: 'የዮሐንስ መልእክት 2',
    name_en: '2 John',
    short_name_am: '2 ዮሐ',
    short_name_en: '2 John',
    testament: 'new',
    total_chapters: 3,
  },
  {
    book_id: 78,
    name_am: '3ኛ የዮሐንስ መልእክት',
    name_en: '3 John',
    short_name_am: '3 ዮሐ',
    short_name_en: '3 John',
    testament: 'new',
    total_chapters: 4,
  },
  {
